...
def prepare_inputs_for_generation(
    ...
    **kwargs,
    ...
    if past_key_values is not None:
        ...
        # )      
        inputs_embeds, input_ids = self._cache_dependant_input_preparation(input_ids, inputs_embeds, kwargs['position_ids'][0])
        #-----------------------------------------------hnx-ed------------------------------------------------
...
def _sample(
    ...
    **model_kwargs,
    ...
    if do_ct:
        ...
        model_kwargs['position_ids'] = model_kwargs['cache_position'][img_ed:].unsqueeze(0).clone()
        ...
        ct_total_len = ct_model_kwargs['attention_mask'].shape[-1]
        input_len = input_ids.shape[-1] - img_ed
        ct_model_kwargs['cache_position'] =  ct_model_kwargs['cache_position'][ct_total_len-input_len:ct_total_len]
        ...
        clear_total_len = model_kwargs['attention_mask'].shape[-1]
        model_kwargs['cache_position'] =  model_kwargs['cache_position'][clear_total_len-input_len:clear_total_len]
    ...
    while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=input_ids.device):
        ...
        ct_model_kwargs['position_ids'] = ct_model_kwargs['position_ids'][:,-1:] + 1
        #------------------------------hnx-ed-------------------------------------
